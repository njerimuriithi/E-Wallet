...
function BankAccount() {
  return (
    <div className='p-6 sm:p-10 space-y-6'>
      <h1 className='text-2xl font-semibold '>My Card Transactions</h1>
    <div class="flex space-x-2   flex items-center justify-between ">
      <div>

        <img src={process.env.PUBLIC_URL + '/Images/MasterCard.png'} class="max-w-full h-auto rounded-lg " alt=""/>
