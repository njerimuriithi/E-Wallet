               ...
               <div class="flex-1 px-3 bg-white divide-y space-y-1">
                  <ul class="space-y-2 pb-2">
                     ...
                     <li>
                           ...
                           <Link to="/" className="text-base text-gray-900 font-normal rounded-lg flex items-center p-2 hover:bg-gray-100 group ml-3">Dashboard</Link>
                     ...
                     <li>
                        <a href="#" target="_blank" class="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group ">
                           ...
                           <span class="ml-3 flex-1 whitespace-nowrap">AllTransactions</span>
                     ...
                     <li>
                        <a href="#" class="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group ">
                           ...
                           <Link to="signup" className="ml-3 flex-1 whitespace-nowrap">Sign Up</Link>
...
{/* <aside  class ="fixed inset-y-0 left-0 bg-white shadow-md max-h-screen w-60">
   <div class="overflow-y-auto py-4 px-3 bg-gray-50 rounded dark:bg-gray-800 flex-grow">
      {/* <a href="https://flowbite.com/" class="flex items-center pl-2.5 mb-5">
         ...
         <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">E-Wallet</span>
      </a> */}
      {/* <ul class="space-y-2">
         <li>
         ...
         <li>
         <Link to="transcations" class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
